...
```sh
Shanbel Kibre. I am 250. I live in Finland
```
...
```js
const paragraph =
  "My name is Shanbel Kibre. I live in Finland, Helsinki.\
...
```sh
I am Shanbel Kibre. I am 250. I live in Finland.
I am Shanbel Kibre. I live in Helsinki, Finland. I am a teacher. I teach JavaScript.
```
...
console.log(firstName.toUpperCase()); // SHANBEL
...
console.log(firstName.toLowerCase()); // shanbel
...
console.log(firstName.split()); // Change to an array - > ["Shanbel"]
console.log(firstName.split("")); // Split to an array at each letter ->  ["S", "h", "a", "n", "b", "e", "l"]
...
let firstName = "Shanbel"; // string
let lastName = "Kibre"; // string
let country = "Finland"; // string
let city = "Helsinki"; // string
let age = 250; // number, it is not my real age, do not worry about it
let job; // undefined, because a value was not assigned

console.log(typeof "Shanbel"); // string
...
2. Use **match()** to count the number of all **because** in the following sentence:\_\_'You cannot end a sentence with because because because is a
