...
[<< Day 2](../02_Day_Data_types/02_day_data_types.md.md) | [Day 4 >>](../04_Day_Conditionals/04_day_conditionals.md.md)
...
1. Compare your first name length and your family name length and you should get this output.
   ...
   ```sh
   Your first name, Shanbel is longer than your family name, Kibre
   ```
