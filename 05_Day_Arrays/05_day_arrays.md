...
[<< Day 4](../04_Day_Conditionals/04_day_conditionals.md.md) | [Day 6 >>](../06_Day_Loops/06_day_loops.md.md)
...
console.log(names.toString()); // Shanbel,Mathias,Elias,Brook
```
...
console.log(names.join()); // Shanbel,Mathias,Elias,Brook
console.log(names.join("")); //ShanbelMathiasEliasBrook
console.log(names.join(" ")); //Shanbel Mathias Elias Brook
console.log(names.join(", ")); //Shanbel, Mathias, Elias, Brook
console.log(names.join(" # ")); //Shanbel # Mathias # Elias # Brook
...
1. Slice the first ten countries from the [countries array](https://github.com/ShanbelKibre/30DaysOfJavaScript/tree/master/data/countries.js)
1. Find the middle country(ies) in the [countries array](https://github.com/ShanbelKibre/30DaysOfJavaScript/tree/master/data/countries.js)
