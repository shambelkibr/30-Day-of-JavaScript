...
[<< Day 8](../09_Day_Higher_order_functions/09_day_higher_order_functions.md.md) | [Day 10 >>](../10_Day_Sets_and_Maps/10_day_Sets_and_Maps.md)
...
```js
const names = ["Shanbel", "Mathias", "Elias", "Brook"];
const namesToUpperCase = names.map((name) => name.toUpperCase());
console.log(namesToUpperCase);
```

```sh
['SHANBEL', 'MATHIAS', 'ELIAS', 'BROOK']
```
...
```sh
[{name: 'Shanbel', score: 95}, { name: 'Lidiya', score: 98 },{name: 'Martha', score: 85},{name: 'John', score: 100}]
```
...
🌕 You are doing great. Never give up because great things take time. You have just completed day 9 challenges and you are 9 steps ahead in to your way to greatness. Now do some exercises for your brain and for your muscle.
...
1. Find the sum of price of products using only reduce(callback))
...
[<< Day 8](../08_Day_OOP/08_day_objects.md) | [Day 10 >>](../10_Day_Sets_and_Maps/10_day_Sets_and_Maps.md)
